...
/* ===================== SERVER & WIFI ===================== */
const char* web_server = "raspberrypi.local"; //raspberrypi local hostname
 
String sendWateringURL = "http://" + String(web_server) + "/smart_farming/api/watering_api.php";
String sendIntelURL = "http://" + String(web_server) + "/smart_farming/api/intel_api.php";
String sendManualURL = "http://" + String(web_server) + "/smart_farming/test/manual_api.php";
